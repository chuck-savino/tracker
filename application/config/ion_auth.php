 ...
 */
$config['site_title']                 = "Issue Tracker";       // Site Title, example.com
$config['company_name']               = "Charles Savino & Co., Inc.";       // Site Title, example.com
$config['admin_email']                = "solutions@csavino.com"; // Admin Email, admin@example.com
